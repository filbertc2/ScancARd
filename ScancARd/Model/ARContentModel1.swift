...
struct ARContentModel1 {
    static func addPlane(anchor: ARImageAnchor, node: SCNNode) {
        ...
        plane.materials.first?.diffuse.contents = UIImage(named: "card11")
        ...
        if let callScene = SCNScene(named: "art.scnassets/call1.scn") {
        ...
        if let emailScene = SCNScene(named: "art.scnassets/email1.scn") {
        ...
        if let mapScene = SCNScene(named: "art.scnassets/map1.scn") {
