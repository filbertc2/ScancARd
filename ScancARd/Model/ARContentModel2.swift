...
struct ARContentModel2 {
    static func addPlane(anchor: ARImageAnchor, node: SCNNode) {
        ...
        plane.materials.first?.diffuse.contents = UIImage(named: "card22")
        ...
        if let callScene = SCNScene(named: "art.scnassets/call2.scn") {
        ...
        if let emailScene = SCNScene(named: "art.scnassets/email2.scn") {
        ...
        if let mapScene = SCNScene(named: "art.scnassets/map2.scn") {
