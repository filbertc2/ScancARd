...
struct ARContentModel4 {
    static func addPlane(anchor: ARImageAnchor, node: SCNNode) {
        ...
        plane.materials.first?.diffuse.contents = UIImage(named: "card44")
        ...
        if let callScene = SCNScene(named: "art.scnassets/call4.scn") {
        ...
        if let emailScene = SCNScene(named: "art.scnassets/email4.scn") {
        ...
        if let mapScene = SCNScene(named: "art.scnassets/map4.scn") {
